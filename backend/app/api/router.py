...
from app.api import papers, ai, auth, users, settings, bookmarks, subscriptions
...
api_router.include_router(subscriptions.router, prefix="/subscriptions", tags=["订阅推送"])
